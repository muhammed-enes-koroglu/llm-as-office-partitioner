...
def define_office_plan():
    """ 
    Rectangle office, 4 persons and 4 desks, 1 disturbing persons, 2 doors, 2 windows, 2 noise points objects.
    ...
    object1 = (constants.OBJECT_RECTANGLE, (3, 5, 0.5, 0.5))
    object2 = (constants.OBJECT_RECTANGLE, (5, 5, 0.5, 0.5))
