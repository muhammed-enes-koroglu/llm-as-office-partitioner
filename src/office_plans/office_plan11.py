...
def define_office_plan():
    """ 
    Rectangle office, 4 persons and 4 desks, 2 disturbing persons, 2 doors, 2 windows, 3 rectangle objects.
    ...
    door2 = ((8,5), (8,6), 170, constants.COUNTERCLOCKWISE)
    doors = [door1, door2]
    ...
    disturbing_person2 = person2
    disturbing_persons = [disturbing_person1, disturbing_person2]


    object1 = (constants.OBJECT_RECTANGLE, (1, 5, 0.5, 0.5))
    object2 = (constants.OBJECT_RECTANGLE, (2, 5, 0.5, 0.5))
    object3 = (constants.OBJECT_RECTANGLE, (3, 5, 0.5, 0.5))
