...
def define_office_plan():
    """ 
    Rectangle office, 4 persons and 4 desks, 2 disturbing persons, 2 doors, 2 windows, 1 polygon object.
    ...
    disturbing_person2 = person3
    disturbing_persons = [disturbing_person1, disturbing_person2]


    object1 = (constants.OBJECT_POLYGON, [(3,5), (4,4), (5,5), (4,6)])
    objects = [object1]
