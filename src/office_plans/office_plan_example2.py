...
def define_office_plan():
    ...
    door2 = ((6.5,5), (7.5,5), 180, constants.COUNTERCLOCKWISE)
    doors = [door1, door2]
    ...
    object1 = (constants.OBJECT_RECTANGLE, (5, 6, 0.5, 0.5))
    object2 = (constants.OBJECT_ROUND, (1, 5, 0.5))
    object3 = (constants.OBJECT_POLYGON, [(1.5,5.5), (2,5.5), (2.5,5), (2,4.5), (1.5,4.5)])
    ...
    moveable_wall1 = (2,3.5,0)
    moveable_wall2 = (2,3.5,-45)
    moveable_wall3 = (2,3,0)
